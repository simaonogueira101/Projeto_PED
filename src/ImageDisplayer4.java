...
public class ImageDisplayer4 extends JPanel{
        ...
        public void drawImage() {
            try {
                ...
                // Apresenta as fotos que ditam o numFotoShowReel
                if(Interface.numFotoShowReel == 0){
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                ...
                if(Interface.numFotoShowReel == 1){
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2, null);
                }
                if(Interface.numFotoShowReel == 2){
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                ...
                if(Interface.numFotoShowReel > 2 && Interface.numFotoShowReel < imagens.size()-1-2){
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                ...
                if(Interface.numFotoShowReel == imagens.size()-1){
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2, null);
                }
                if(Interface.numFotoShowReel == imagens.size()-1-1){
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2, null);
                }
                if(Interface.numFotoShowReel == imagens.size()-1-2){
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                ...
                if(Interface.numFotoShowReel < imagens.size()-1-2 && Interface.numFotoShowReel > 2){
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+2), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 180, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 60, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel-1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 - 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
                    image.getGraphics().drawImage(albumIcons.get(Interface.numFotoShowReel+1), WIDTH/2 - albumIcons.get(Interface.numFotoShowReel).getWidth(this)/2 + 90, HEIGHT/2 - albumIcons.get(Interface.numFotoShowReel).getHeight(this)/2 + 30, null);
